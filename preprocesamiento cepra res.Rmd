...
datos <- datos_ori |> 
  mutate(
    ...
    movac_obesity_4l= factor(recode(movact_previene_obesidad,
    ...
    movac_cvrisk_4l= factor(recode(movact_reduce_riesgo,
                                "Muy en desacuerdo"="Totally disagree",
                                "Algo en desacuerdo"="Somehow disagree",
                                "Algo de acuerdo"="Somehow agree", 
                                "Muy de acuerdo"="Totally agree",
    ...
    movac_pollut_4l= factor(recode(movact_disminuye_contam,
                                "Muy en desacuerdo"="Totally disagree",
                                "Algo en desacuerdo"="Somehow disagree",
                                "Algo de acuerdo"="Somehow agree", 
                                "Muy de acuerdo"="Totally agree",
    ...
    movac_traffic_4l= factor(recode(movact_disminuye_trafico,
                                 "Muy en desacuerdo"="Totally disagree",
                                 "Algo en desacuerdo"="Somehow disagree",
                                 "Algo de acuerdo"="Somehow agree", 
                                 "Muy de acuerdo"="Totally agree",
    ...
    movac_academic_4l= factor(recode(movact_mejora_academia,
                                  "Muy en desacuerdo"="Totally disagree",
                                  "Algo en desacuerdo"="Somehow disagree",
                                  "Algo de acuerdo"="Somehow agree", 
                                  "Muy de acuerdo"="Totally agree",
    ...
    movac_obesity= factor(recode(movact_previene_obesidad,
                                 "Muy en desacuerdo"="disagree",
                                 "Algo en desacuerdo"="disagree",
                                 "Algo de acuerdo"="agree", 
                                 "Muy de acuerdo"="agree",
                                 "No sabe/No contesta"="N.A."
    )),
